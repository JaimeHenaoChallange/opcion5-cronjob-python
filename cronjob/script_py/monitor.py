...
def get_app_version(app):
    ...
    try:
        ...
        print(f"❌ Error al obtener la versión de la aplicación: {e}")
        return "unknown"
...
def rollback_application(app_name):
    ...
    try:
        ...
        print(f"❌ Error inesperado durante el rollback: {e}")
...
def main():
    ...
    try:
            ...
            try:
                ...
                for app in apps:
                    try:
                        ...
                        print(f"❌ Error al procesar la aplicación '{app_name}': {e}")
        ...
        print(f"❌ Error al iniciar el monitor: {e}")
